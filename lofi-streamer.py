...
def start_stream(track: Path, stream_url: str, video_file: Optional[Path], duration: int):
...
def main():
    print("🌙 LOFI STREAMER v7.4 — Bottom-Hugging Text + Cinematic Bar\n")
